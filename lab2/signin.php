...
if (isset($_POST['login'])) {
  ...
  if (mysqli_num_rows($result) == 1) {
    ...
    exit; // Ensure script termination after echo
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a href="staffsignin.php" class="nav-link scrollto">Staff Login</a></li>
      ...
      <div class="card">
        <form method="POST">
          <div class="text-center">
            <label id="log-heading" for="heading">LOGIN</label>
          </div>
          <div class="container mb-5" id="log-fields">
            <div class="col-md-12">
          ...
          <div class="text-center mb-5">
            <input type="submit" name="login" class="btn" style="background-color: #1977cc;color: azure;" value="SUBMIT">
