...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <div class="card">
        <div class="text-center"><label id="log-heading" for="heading">STAFF</label></div>
        <form method="post">
          ...
          <div class="text-center mb-5">
            <input type="submit" name="loginstaff" class="btn" style="background-color: #1977cc;color: azure;" value="SUBMIT">
