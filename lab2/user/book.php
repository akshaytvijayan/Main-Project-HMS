          ...
          <div class="row">
            <div class="container" style="width: 80%;">
              ...
              <form id="appointment-form" method="post">
                ...
                <input class="form-control" type="hidden" id="name" style="background-color:lightgrey;" name="name" value="<?php echo $username; ?>" readonly><br>

                <!-- <label for="email">Email:</label> -->
                <input class="form-control" type="hidden" id="email" style="background-color:lightgrey;" name="email" value="<?php echo $email; ?>" readonly><br>
                ...
                <div class="col-12 mb-3">
                  ...
                  <textarea style="background-color:lightgrey;resize:none;" class="form-control" id="description" name="description" rows="4" cols="50" readonly></textarea><br>
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (data.status === 'pending') {
              // There's a pending appointment, alert the user
              alert('You have a pending appointment on ' + data.date + '. Please update or delete the pending request.');
            } else if (data.status === 'success') {
              // Appointment successfully inserted, display success message or take further action
