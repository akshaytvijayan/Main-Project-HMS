...
<body class="hold-transition ">
  ...
  <?php if($_settings->chk_flashdata('success')): ?>
      ...
      <?php endif;?> 
  <header>
    <a href="../index.php" class="btn btn-danger mt-3 ml-3">Back to Home</a>
  </header>    
  <div class="h-100 d-flex align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        <center><img src="C:\AppServ\www\odlms\uploads\lab.jpg" alt="" id=""></center>
        <h1 class="text-center py-5 login-title"><b>Laboratory</b></h1>
      </div>
