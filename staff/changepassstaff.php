...
$result = "SELECT * FROM staffdb where email='$username'";
...
if (isset($_POST["btnsubmit"])) {
    ...
    if ($curentpwd == $cc) {
        ...
        $result = "UPDATE staffdb SET password='$ccpassword' WHERE email='$username'";
        $sql = mysqli_query($con, $result);
        if ($sql) {
            echo "<script>alert('Password Updated Succesfully!!Plase login again!!');window.location='admin-panel3.php'</script>";
        }
    } else
        echo "<script>alert('Please enter current password correctlty!!');window.location='changepassstaff.php'</script>";
}
?>
        ...
        <div class="row">
            <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
                <div class="list-group" id="list-tab" role="tablist">
                    <a class="list-group-item list-group-item-action" id="list-dash-list" data-toggle="list" href="#list-dash" role="tab" aria-controls="home" href="admin-panel3.php">Dashboard</a>
                    <a class=" list-group-item list-group-item-action " href=" viewprofile.php" href="#list-doc">Profile</a>
                    <a class="list-group-item list-group-item-action active" href="changepassstaff.php">Change Password</a>
