...
if (isset($_POST['schedule'])) {
    ...
    $date = $_POST['date'];
    $time = $_POST['timeslot'];
     $query = "INSERT INTO offline_appointments (Specialization, username, AppoID, patname, patage, patwork, contact, date, time)
     VALUES ('$Specialization', '$username', '$AppoID', '$patname', '$patage', '$patwork', '$contact', '$date', '$time')";
                                ...
                                <form action="" method="post">
                                    <div class="form-group row">
                                        <label for="Specialization"
                                            class="col-sm-4 col-form-label">Specialization</label>
                                        <div class="col-sm-8">
                                            <select class="form-control" id="Specialization" name="Specialization"
                                                required>
                                                <option value="" disabled selected>Select Specialization
                                                </option>
                                                <option value="Anatomical Pathology">Anatomical Pathology
                                                </option>
                                                ...
                                                <option value="Cardiovascular/Thoracic Surgery">
                                                    ...
                                                    Surgery</option>
                                                <option value="Clinical Immunology/Allergy">Clinical
                                                    Immunology/Allergy
                                                </option>
                                                <option value="Critical Care Medicine">Critical Care
                                                    Medicine</option>
                                                ...
                                                <option value="Endocrinology and Metabolism">Endocrinology
                                                    and
                                                    Metabolism</option>
                                                <option value="Family Medicine">Family Medicine</option>
                                                <option value="Gastroenterology">Gastroenterology</option>
                                                <option value="General Internal Medicine">General Internal
                                                    Medicine
                                                </option>
                                                <option value="General Surgery">General Surgery</option>
                                                <option value="General/Clinical Pathology">General/Clinical
                                                    Pathology
                                                </option>
                                                ...
                                                <option value="Obstetrics/Gynecology">Obstetrics/Gynecology
                                                </option>
                                                <option value="Occupational Medicine">Occupational Medicine
                                                </option>
                                        ...
                                        <script>
                                            // JavaScript to persist selected option
                                        ...
                                        if (isset($_POST['Search'])) {
                                            ...
                                            <div class="form-group row">
                                                <label for="AppoID" class="col-sm-4 col-form-label">Appointment
                                                    ID</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="AppoID" id="AppoID"
                                                        value="<?php echo mt_rand(1000, 9999); ?>" readonly>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label for="patname" class="col-sm-4 col-form-label">Patient
                                                    Name</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="patage" class="col-sm-4 col-form-label">Patient
                                                    Age</label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                                <label for="patwork" class="col-sm-4 col-form-label">Patient
                                                    Work</label>
                                                <div class="col-sm-8">
