                ...
                <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                    <div class="container-fluid">
                        <div class="card">
                            ...
                            <center>
                                <h4>View Profile</h4><a href="editprofile2.php"><i class="fa fa-pen"></i></a>
                            </center><br>
                            <?php
                            $query = "SELECT * FROM staffdb WHERE email = '$username'";
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm">
                                                    ...
                                                    <input type="text" id="location" name="location" class="form-control" value="<?php echo $row['location']; ?>" readonly>
