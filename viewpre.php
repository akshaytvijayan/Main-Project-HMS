                            ...
                            <div class="row">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $con = mysqli_connect("localhost", "root", "", "myhmsdb");
                                        global $con;
                                        $query = "SELECT * FROM appointmenttb WHERE doctor='$doc_row_name'  and status='approve' ORDER BY id DESC ";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_details.php?id=<?php echo $row['ID']; ?>" class="btn btn-primary">View Details</a>
                                                    </td>
                                                </tr>
                                            <?php $ml++;
                                            }
                            ...
                            <div class="row">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $con = mysqli_connect("localhost", "root", "", "myhmsdb");
                                        global $con;
                                        $query = "SELECT * FROM `prestb2` WHERE doctor='$doc_row_name' ORDER BY t_id DESC";
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="view_details2.php?id=<?php echo $row['t_id']; ?>" class="btn btn-primary">View Details</a>
                                                    </td>
                                                </tr>
                                            <?php $ml++;
                                            }
